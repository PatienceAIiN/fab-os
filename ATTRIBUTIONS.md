...
| whisper.cpp 1.8.3 (`whisper-cli`, libggml0) | github.com/ggml-org/whisper.cpp | MIT (THIRD_PARTY_LICENSES/MIT.txt) | 2023-2026 The ggml authors | No (Ubuntu package `whisper.cpp`) | keep notice |
...
| PocketSphinx 5.0.4 + `pocketsphinx-en-us` (en-us acoustic model, cmudict-en-us dictionary, language model) | github.com/cmusphinx/pocketsphinx | BSD-2-Clause (THIRD_PARTY_LICENSES/BSD-2-Clause.txt) | 1995-2014 Carnegie Mellon University (per the Debian copyright file of pocketsphinx 5.0.4-3ubuntu1) | No (Ubuntu packages) | keep copyright notice and disclaimer |
