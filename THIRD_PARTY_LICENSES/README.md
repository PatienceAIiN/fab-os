...
| `MPL-2.0.txt` | Mozilla Public License 2.0 | Firefox (Mozilla's unmodified .deb from packages.mozilla.org; ADR-0018 — the same text covered Brave in the 1.0-3/1.0-4 images) |
