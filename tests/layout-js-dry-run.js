...
assert.strictEqual(quick.config["General:magnify"], true); assert.strictEqual(quick.config["General:magnification"], "normal");
assert.strictEqual(tasks.config["General:magnify"], quick.config["General:magnify"], "dock and bar share the magnify default");
assert.strictEqual(tasks.config["General:magnification"], quick.config["General:magnification"]);
