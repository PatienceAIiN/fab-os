...
chk "kwinrc selects the FabOS decoration"     "R 'grep -q ^library=org.kde.kwin.aurorae /etc/xdg/kwinrc && grep -q ^theme=__aurorae__svg__FabOS$ /etc/xdg/kwinrc && grep -q ^BorderSizeAuto=false /etc/xdg/kwinrc && grep -q ^BorderSize=None /etc/xdg/kwinrc'"
chk "look-and-feel defaults select FabOS/FabOSLight" "R 'grep -q ^theme=__aurorae__svg__FabOS$ /usr/share/plasma/look-and-feel/in.patienceai.fabos.desktop/contents/defaults && grep -q ^theme=__aurorae__svg__FabOSLight$ /usr/share/plasma/look-and-feel/in.patienceai.fabos.light.desktop/contents/defaults'"
chk "Aurorae engine installed"                "R 'test -f /usr/lib/x86_64-linux-gnu/qt6/plugins/org.kde.kdecoration3/org.kde.kwin.aurorae.so && test -f /usr/share/kwin/aurorae/aurorae.qml'"
...
chk "FabOS mono status icons follow scheme"   "R 'grep -q ColorScheme-Text /usr/share/icons/FabOS/scalable/status/network-wireless-signal-excellent.svg && grep -q current-color-scheme /usr/share/icons/FabOS/scalable/status/network-wireless-connected-100.svg && test -e /usr/share/icons/FabOS/scalable/status/battery-080-charging.svg && test -e /usr/share/icons/FabOS/scalable/status/audio-volume-high.svg && test -e /usr/share/icons/FabOS/scalable/status/preferences-system-bluetooth.svg && test -e /usr/share/icons/FabOS/scalable/actions/arrow-down.svg && test -e /usr/share/icons/FabOS/scalable/places/user-desktop.svg'"
