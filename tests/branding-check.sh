...
chk "low-RAM login tune shipped and hooked before KWin starts" "R 'test -x /usr/lib/fabos/lowram-tune && grep -q lowram-tune /etc/xdg/plasma-workspace/env/40-fabos-lowram.sh && grep -q blurEnabled /usr/lib/fabos/lowram-tune && grep -q 3500000 /usr/lib/fabos/lowram-tune'"
