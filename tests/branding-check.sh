...
chk "no Fab OS setuid binaries (stock Ubuntu SUID set only)" "[ -z \"\$(R 'find /usr/lib/fabos /usr/share/fabos /usr/bin/fabos* /usr/bin/aios -xdev -perm -4000 -type f 2>/dev/null')\" ]"
