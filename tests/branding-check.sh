...
chk "decoration: corner notches transparent (L-shaped shadow paths + desc)" "R 'grep -q notch /usr/share/aurorae/themes/FabOS/decoration.svg && grep -q \"d=\\\"M0 0H42V28H28V42H0Z\\\"\" /usr/share/aurorae/themes/FabOS/decoration.svg && grep -q \"d=\\\"M50 0H92V42H64V28H50Z\\\"\" /usr/share/aurorae/themes/FabOS/decoration.svg'"   # 2026-09-15 (ADR-0019): literals rewritten in place for R = 14 (LW 42, block 92); the old ones were the radius-20 geometry
