...
Patience AI does **not** claim ownership of Ubuntu, KDE, Brave or any other upstream code. Copyright notices,
...
- **Trademarks**: Ubuntu (Canonical), KDE/Plasma (KDE e.V.), Brave (Brave Software, Inc.) are named only for identification;
...
- **Brave Browser**: Brave's own unmodified official package from Brave's apt repository; Fab OS does not rebuild, rename or
  re-brand it. Brave and the Brave lion logo are trademarks of Brave Software, Inc.; Fab OS is not endorsed by Brave Software.
